...
namespace TESTING
{
    public class Texting_Architect : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            string longline = "This is a very long line that makes no sense but I am just populating it with stuff because, you know, stuff is good right? I like stuffing things and my turkey to be stuffed";
